...
import { 
  HomeWrap,HomeSectionLine,HomeSectionBubble1,HomeSectionBubble2,Highlight,HomeSection,
  SectionTit,FlexWrap,FlexBox,TextContainer,ScreenContainer,MainLinkBtn,
  SectionReview,HomeReview,ReviewRow,ReviewCard,ReviewCardBox,Footer
} from '../styles/s-home';
...
const Home = () => {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then(res=>{setReviewArr(res.data.data)})
  ...
  return (
    <>
          ...
          <FlexWrap flexai='center'>
            ...
            <FlexBox order='1' width='45%' data-aos="fade-down" data-aos-duration="2000" data-aos-once="true">
              <TextContainer>
                ...
                <MainLinkBtn onClick={()=>navigate('/list')}>바로가기</MainLinkBtn>
              </TextContainer>
            </FlexBox>
          </FlexWrap>
        </HomeSection>
          ...
          <FlexWrap>
            ...
            <FlexBox width='45%' data-aos="fade-down" data-aos-duration="2000" data-aos-once="true">
              <TextContainer textAlign='right'>
                ...
                <MainLinkBtn onClick={()=>navigate('/mypharm')} marginLeft='auto'>바로가기</MainLinkBtn>
              </TextContainer>
            </FlexBox>
          </FlexWrap>
        </HomeSection>
          ...
          <FlexWrap>
            ...
            <FlexBox order='1' width='45%' data-aos="fade-down" data-aos-duration="2000" data-aos-delay="300" data-aos-once="true">
              <TextContainer>
                ...
                <MainLinkBtn onClick={()=>navigate('/chart')}>바로가기</MainLinkBtn>
              </TextContainer>
            </FlexBox>
          </FlexWrap>
        </HomeSection>
      ...
      <SectionReview>
        <SectionTit className='center' data-aos="fade-down" data-aos-duration="2000" data-aos-once="true">PharmPalm 리뷰</SectionTit>
        <HomeReview>
          <ReviewRow>
            {
              reviewArr.map((item,idx)=>(
                <ReviewCard key={idx}>
                  <ReviewCardBox>
                    <div className='imgbox'><img src={item.memberImg?item.memberImg:`https://picsum.photos/300/200`} alt={`${item.memberName} 리뷰`} /></div>
        ...
        <FlexWrap>
          <Flexbox className='footer-nav'>
            ...
            <ul>
              ...
              <li><Link to='/list'>의약품 조회</Link></li>
              <li><Link to='/mypharm'>내 약 관리</Link></li>
              <li><Link to='/chart'>차트데이터</Link></li>
            </ul>
          </Flexbox>
        <img className='none-pc' src='/logo2.png' alt='logo' />
          <Flexbox className='footer-link'>
            <p><Link to='https://github.com/codestates-seb/seb42_main_009' target='_blank'><BsGithub/> <span>pharmpalm github</span></Link></p>
            <ul>
              <li><Link to='https://github.com/hunjeong93' target='_blank'>곽훈정</Link></li>
              <li><Link to='https://github.com/yeojin15' target='_blank'>김여진</Link></li>
              <li><Link to='https://github.com/jin-yeong-kim' target='_blank'>김진영</Link></li>
              <li><Link to='https://github.com/RaYul18' target='_blank'>심라율</Link></li>
              <li><Link to='https://github.com/leechiyun' target='_blank'>이치윤</Link></li>
            </ul>
          </Flexbox>
        </FlexWrap>
